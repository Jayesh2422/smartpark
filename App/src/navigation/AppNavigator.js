...
function HomeTabs() {
    return (
        <Tab.Navigator
            screenOptions={({ route }) => ({
                ...
                tabBarIcon: ({ focused, color, size }) => {
                    ...
                    else if (route.name === 'VehiclesTab') iconName = focused ? 'car-sport' : 'car-sport-outline';
        ...
        >
            ...
            <Tab.Screen name="VehiclesTab" component={VehiclesScreen} options={{ title: 'Vehicles' }} />
